clear
%addpath(genpath('/home/yzhang12/Desktop/cvx-a64/cvx'))
%cvx_setup
d = 8;
alpha= 100;   
beta = 300;
...
gamm_end = 3;
k=10;
load('/home/yzhang12/Desktop/drmf_spl/100k//Train.mat')
Train = Train/5; %normalize ratings to [0,1]
load('/home/yzhang12/Desktop/drmf_spl/100k//Test.mat')
Test = Test./5;
[N,M] = size(Train);
...
while gamm < gamm_end
         for t=1:times            
             ...
             fid=fopen('/home/yzhang12/Desktop/drmf_spl/100k//dis_spl_iteration.txt','a');
         ...
         sprintf('testing ...')
         ndcg = rating_metric(Test, P, Q, k);
         fid=fopen('/home/yzhang12/Desktop/drmf_spl/100k//dis_spl.txt','a');
         %         fprintf(fid,'step= %d, gamm1= %f,gamm2= %f, alpha= %f, beta= %f \n', step, gamm1,gamm2, alpha , beta);
         fprintf(fid,'step= %d, gamm %f, alpha= %f, beta= %f \n', gamm, alpha , beta);
         for i=1:k
             fprintf(fid,'%d, %f \n',[i, ndcg(i)]);
